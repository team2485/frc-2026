...
public final class DistanceLookup { // Singleton class
    ...
    private static double distancesOffset = -1.35; // This number can be used to easily change shot distance :)
    private DistanceLookup(){
        ...
        intTable.put(3.08, 0.29-0.03);
        intTable.put(3.6, 0.3+0.03);
        intTable.put(4.4, 0.37-0.03);
        // Add a 2.5 entry to the table if possible
